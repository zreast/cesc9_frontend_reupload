		...
		<div class="col-md-7 col-md-offset-1">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-user"></i>ข้อมูลส่วนตัว <small>น้องๆ ช่วยกรอกข้อมูลตามความจริงให้ด้วยนะคะ</small></h3>
				</div>
				@if (count($errors) > 0)
				...
				<div class="col-xs-4 col-xs-offset-4">
					<div class="text-center">
						<a href="{{ route('student.applicant.edit') }}">
							<button type="submit" class="btn btn-block btn-success"  style="margin-bottom: 15px;">บันทึกข้อมูล</button>
						</a>
					</div>
				</div>
			</div>
